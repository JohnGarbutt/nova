...
class VMOpsTestCase(test.NoDBTestCase):
    ...
    def test_finish_revert_migration_after_crash_vm_running(self):
        self._test_finish_revert_migration_after_crash(True, True, False)
...
class MigrateDiskResizingUpTestCase(VMOpsTestBase):
    ...
    def test_migrate_disk_resizing_up_works_with_two_ephemeral(self,
        ...
        m_vhd_expected = [mock.call(instance, "parent", dest, sr_path, 1),
                          mock.call(instance, "grandp", dest, sr_path, 2),
                          mock.call(instance, "4-parent", dest, sr_path, 1, 1),
                          mock.call(instance, "5-parent", dest, sr_path, 1, 2),
                          mock.call(instance, "leaf", dest, sr_path, 0),
                          mock.call(instance, "4-leaf", dest, sr_path, 0, 1),
                          mock.call(instance, "5-leaf", dest, sr_path, 0, 2)]
        self.assertEqual(m_vhd_expected, mock_migrate_vhd.call_args_list)
